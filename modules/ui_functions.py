...
class UIFunctions(MainWindow):
    ...
    def toggleLeftBox(self, enable):
        if enable:
            ...
            widthToolBox = self.ui.toolBoxMenu.width()
        ...
        UIFunctions.start_box_animation(self, width, widthRightBox, "left", widthToolBox)


    # TOGGLE TOOL BOX
    # ///////////////////////////////////////////////////////////////
    def toggleToolBox(self, enable):
        if enable:
            # GET WIDTH
            width = self.ui.toolBoxMenu.width()
            widthRightBox = self.ui.extraRightBox.width()
            widthLeftBox = self.ui.extraLeftBox.width()
            maxExtend = Settings.TOOL_BOX_WIDTH
            color = Settings.BTN_TOOL_BOX_COLOR
            standard = 0
    ...
    def toggleRightBox(self, enable):
        if enable:
            ...
            UIFunctions.start_box_animation(self, widthLeftBox, width, "right", widthToolBox)

    def start_box_animation(self, left_box_width, right_box_width, direction, tool_box_width):
        right_width = 0
        left_width = 0
        tool_width = 0
        ...
        if tool_box_width == 0 and direction == "toolbox":
            tool_width = 240
        else:
            tool_width = 0
        ...
        self.tool_box.setStartValue(tool_box_width)
        self.tool_box.setEndValue(tool_width)
